##############################################################################
## This script reproduces Fig. 3e of Chira et al. (2019).                   ##
##############################################################################
...
for ijeans in range(len(fjeans)):
    ...
    if(ijeans == 0): 
        ...
        ax[ijeans].text(0.15,1.7,txtstr,alpha=1.0,backgroundcolor="white",verticalalignment='top')
    if(ijeans == 2): 
...
fig.savefig(dfig+'fig3e_zeta_all_part2.pdf')
