##############################################################################
## This script reproduces Fig. 2a-d of Chira et al. (2019).                 ##
##############################################################################
...
for icloud in range(len(fcloud)):
    ...
    if(icloud == 0): 
        ...
        ax[0,icloud].text(0.15,4.65,txtstr,alpha=1.0,backgroundcolor="white",verticalalignment='top')
    if(icloud == 2): 
...
for icloud in range(len(fcloud)):
    ...
    if(icloud == 0): 
        ...
        ax[1,icloud].text(0.15,4.65,txtstr,alpha=1.0,backgroundcolor="white",verticalalignment='top')
    if(icloud == 2): 
...
for icloud in range(len(fcloud)):
    ...
    if(icloud == 0): 
        ...
        ax[2,icloud].text(0.15,0.5,txtstr,alpha=1.0,backgroundcolor="white",verticalalignment='top')
    if(icloud == 2): 
...
for icloud in range(len(fcloud)):
    ...
    if(icloud == 0): 
        ...
        ax[3,icloud].text(0.15,4.75,txtstr,alpha=1.0,backgroundcolor="white",verticalalignment='top')
...
fig.savefig(dfig+'fig2a-d_zeta_all_part1.pdf')