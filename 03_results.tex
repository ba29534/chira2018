...
\textbf{
	\citetalias{IbanezMejia2017} also discuss the influence of these SNe onto the modelled clouds.
...
\rc{
	Commennt N by referee: more precise description when 1D and 3D converge or not.
}
