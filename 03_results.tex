...
Note that these flows mean that the turbulence we study here is not uniform or isotropic, as was assumed by \citet{She1994} and \citet{Boldyrev2002}.
Thus, derived VSFs are not only functions of time and lag, but also the direction of $\vec{\ell}$, as that direction defines at which scales of $\ell$ large scale structures become relevant.
