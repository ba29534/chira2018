...
\textbf{
The figure shows the VSFs of all three clouds (columns) at three different times in their evolutions, more precisely at 1.0~Myr, 3.0~Myr, and 4.2~Myr after the on-set of gravity. 
}
...
\textbf{All clouds at $t$~=~1.0~Myr} shows the case where turbulence is driven on large scales and naturally decays towards smaller scales.
