...
The picture changes when analysing the VSFs based on the $\lambda_J$~=~$32\Delta{}x$ runs (Figs.~\ref{pic:results:zeta_all}c,~\ref{pic:results:z_all}c, and~\ref{pic:results:jeans_comp} \textit{bottom} panel).
