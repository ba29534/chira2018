...
Second, $\zeta$ for all orders decreases with time as the clouds are first refined and then begin to gravitationally collapse. 
Distributed gravitational collapse causes an increase in relative velocities at increasingly small scales as material falls into filaments and nodes.
The increase in small-scale power leads to a flattening or even inversion of the VSF and thus a decrease in $\zeta$.
