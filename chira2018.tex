...
%rc have cut the text. still need to count the new amount of words.
\abstract
	{ %context    	
        Supersonic disordered flows accompany the formation and evolution of molecular clouds (MCs). 
        It has been argued that this is turbulence that can support against gravitational collapse and promote the formation of hierarchical sub-structures. 
    	}
	{ %aims
    	\textbf{
    	We investigate the time evolution of gas dynamics within simulated MCs. 
        We focus on the following questions: 
        What physical process dominates the driving of the disordered flows seen?
	...
	{ %methods 
    	\textbf{
    	We follow the gas motions within three MCs that have formed self-consistently within kiloparsec-scale numerical simulations of the interstellar medium (ISM). 
        ...
        We characterise the flow using velocity structure functions (VSFs) with and without density weighting or a density cutoff.
        }
    	}
	{ %results
        \textbf{
        When the MCs are dominated by the turbulence of their parent medium, the density-weighted VSFs follow the expectations for uniform turbulence, with a second order scaling coefficient consistent with Larson's size-velocity relationship. 
        ...
        Removing the density weighting reduces this effect as that emphasises lower-density regions at larger scales.
        }
    	}
	{ %conclusions
        \textbf{
        We conclude that two different effects coincidentally act at different stages in MC evolution. 
        Where uniform turbulence dominates, the energy cascade produces VSFs consistent with Larson's relationship. 
        Where contraction dominates, the density-weighted VSFs become much shallower or even inverted, but the relationship of the global average velocity dispersion of the MCs to their radius follows Larson's relationship reflecting free-fall collapse or virial equilibrium.
        The injection of energy by shocks is visible in the VSFs, but decays within a crossing time. 
        Our results for VSFs are consistent with observed VSFs of MCs with embedded star formation activity.
        }
	}
