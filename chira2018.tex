...
\abstract
	...
	{ %results
    	We demonstrate that the scaling exponent of VSFs is sensitive parameter that traces the dominant source of turbulence driving in both simulated and observational data. When gravity dominates the dynamics of the gas, the scaling exponents decline while the self-similarity parameters are constant. When the gas is interacting with shock fronts or strong winds the exponents increase while the self-similarity parameters decline. The effect of such interactions, however, lasts only for short periods of time ($<$~0.6~Myr) in our simulations. The general evolution is mostly robust against the influence of projection, Jeans refinement and density-weighting, yet the detailed evolution may vary significantly. Only varying the density threshold, that defines which regions are considered in the analysis, has a significant influence on the VSFs.
    }
	{ %conclusions
        We conclude that the VSF is a well placed and stable method for examining the composition, structure and evolution of turbulence within the MCs. Yet, it is essential to clearly define the underlying conditions of the analysis in order to make the results comparable to analogue studies. In our case, we find clear indicators of how the VSF reacts to the dynamics in the simulated clouds. The turbulence in the clouds is dominantly driven by contraction, as a reaction to the on-set of self-gravity within the simulations. Occasionally, SN shocks disturb the dynamics within the clouds and inject new kinetic energy on large scales into the systems. Yet, the effect lasts only for a short period of time before gravity dominates the energy cascade again.
    }
