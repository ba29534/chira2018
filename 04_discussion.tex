...
The origin of these differences are to be found in the underlying physical conditions. 
...
Consequent, deviations between the predicted and our measured values are unavoidable for most of the studied scenarios. 
}
...
\textbf{
Thereby, the VSFs are about four-times higher than the values that are predicted by \citep{Boldyrev2002} for incompressible flows.
}
...
These measurements belong roughly to the evolutionary stages of the modelled clouds after having evolved for \textbf{1.0--3.9~Myr after the onset of self-gravity (or within the range of 0.0--3.9~Myr if we consider the errors of the observational values)}.
...
\textbf{
Fig.~\ref{pic:results:vsf_example}, as well as the figures in Appendix \ref{appFitting} demonstrate that neglecting certain regimes, in particular at small scales where column densities are highest, does have significant influence on the shape and scaling of the corresponding VSF.
}
