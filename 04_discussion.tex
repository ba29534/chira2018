...
The behaviour of \texttt{M8} appears to contradict the explanations we have given for the evolution within \texttt{M3} and \texttt{M4}.
...
\rc{That those fluctuations really represent the turbulent nature of the ISM gas and not a super-position of multiple shocks, that are too weak to influence the compact clouds, becomes evident in the evolution of $Z$ (see Fig.~\ref{pic:results:z_all}d). }


\subsection{The Effect of Density Weighting}\label{discussion:densweight}

\rc{Thus, we can trace the discrepancies between the scaling exponents of density-weighted and non-weighted VSFs back to the disability of the non-weighted VSFs to follow the transition form large-scale driven to small-scale dominated distributions of turbulent power.}
