...
\textbf{
    Note that the FLASH AMR simulations contain, in our case, ten levels of resolution; and the decision which region is resolved up to which level depends on the density of the respective grid cell \citepalias{IbanezMejia2017}.
    Therefore, the simulations cover a range of resolutions from 30.4~pc in regions of $|$10$|$-- $|$20$|$~pc around the midplane of the modelled galactic plane down to 0.06--0.10~pc within a (100~pc)$^3$ box around the centre of mass of the three molecular clouds presented in this manuscript, as well as in \citetalias{IbanezMejia2017} and \citetalias{Chira2018}. 
