...
\textbf{We conclude that improving the resolution resolves details that can affect the VSF, but that the overall behavior is already determined by our moderate resolution simulations.}
