...
The analysis in this paper is based on a sample of three molecular clouds (MCs) found within a \textbf{three-dimensional, magnetohydrodynamical, adaptive mesh refinement simulation by \citetalias{IbanezMejia2016}, using the FLASH code \citep{Fryxell2000}.
\citetalias{IbanezMejia2016,IbanezMejia2017}, as well as \citet[\citetalias{Chira2018} hereafter]{Chira2018}} describe the simulations and the clouds in more detail. 
