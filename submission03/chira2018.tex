...
\abstract
	...
	{ %aims
        ...
        Are they consistent with \textbf{uniform} turbulence or gravitational collapse?
	...
	{ %methods 
        ...
        (VSFs) with and without density weighting or a density cutoff, \textbf{
        and computed in one or three dimensions. 
	...
	{ %results
	    \textbf{In regions with sufficient resolution, the density-weighted VSFs initially appear to follow the expectations for uniform turbulence, with a first-order power-law exponent} consistent with Larson's size-velocity relationship. 
        SN blast wave impacts on MCs produce short-lived coherent motions at large scales, increasing the scaling \textbf{exponents} for a crossing time. Gravitational contraction drives small-scale motions, producing scaling coefficients that drop \textbf{or even turn negative}
        as small scales become dominant.
...
\textbf{
  ...
  % mm2 three different times in their evolutions, more precisely at
        times of
...
% mm2 \citep[see][]{IbanezMejia2017,Seifried2017b}.
     (see \citetalias{IbanezMejia2017}, \citealt{Seifried2017b}).
